        ...
        <ImageBackground>
          <Content>
            ...
            <View  withBorder style={{borderWidth:1, borderRadius: 14, backgroundColor: 'white', marginLeft:48, marginRight: 48}}>
              ...
              <View commonView> 
                <Text subtitle-black>{`You have successfully withdrawn ${this.props.data.toAmount} ${this.props.data.toCurrency} to ${this.props.data.selectedBeneficiary.name}.`}</Text>
              </View>
              <View commonView> 
                <Text subtitle-black>{`${this.props.data.fromAmount} ${this.props.data.fromCurrency} will be deducted from your ${this.props.data.fromCurrency} wallet.`}</Text>
              </View>
              <View commonView horizontal style={{marginTop:10}}> 
                <Text subtitle-black >{`Your transaction ID is `}</Text>  
                <Text subtitle-black red>{this.props.data.referenceNo}</Text>
              </View> 
